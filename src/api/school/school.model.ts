...
export const SchoolSchema = z.object({
  ...
  new_program: z.boolean().default(false),

  excerpt: z.coerce.string().nullable().default(null),
  hide: z.coerce.boolean().default(false),
  ...
  last_60_units: z.coerce.boolean().default(false),
  last_60_units_notes: z.coerce.string().nullable().default(null),
  gre: z.coerce.boolean().default(false),
  ...
  online_components: z.coerce.boolean().default(false),
  ...
  fully_online_semesters: z.coerce.boolean().default(false),
  ...
  see_cost_included: z.coerce.boolean().default(false),
  nce_cost_included: z.coerce.boolean().default(false),
  conference_fee_included: z.coerce.boolean().default(false),
  board_prep_materials_included: z.coerce.boolean().default(false),
  free_housing_for_distant_clinical_sites: z.coerce.boolean().default(false),
  cost_of_living: z.coerce.number().default(0),

  // ? Facilities
  simulation_lab: z.coerce.boolean().default(false),
  simulation_lab_notes: z.coerce.string().nullable().default(null),
  cadaver_lab: z.coerce.boolean().default(false),
  cadaver_lab_notes: z.coerce.string().nullable().default(null),
  crna_only_sites: z.coerce.boolean().default(false),
  ...
  primary_home_clinical_site: z.coerce.boolean().default(false),
  out_of_state_clinical_site: z.coerce.boolean().default(false),
  relocation_for_clinical_sites: z.coerce.boolean().default(false),
  ability_to_create_own_clinical_rotations: z.coerce.boolean().default(false),

  // ? Shifts & Schedules
  call_overnight_shifts_requirement: z.coerce.boolean().default(false),
  weekend_shifts_requirement: z.coerce.boolean().default(false),
  holiday_shift_requirement: z.coerce.boolean().default(false),
  mission_trip_opportunities: z.coerce.boolean().default(false),
  ...
  use_of_aas: z.coerce.boolean().default(false),
  md_do_anesthesiology_residents_presence: z.coerce.boolean().default(false),
  rrnas_from_other_programs: z.coerce.boolean().default(false),
  impact_of_competing_learners: z.coerce.boolean().default(false),
  academic_medical_center_clinical_sites: z.coerce.boolean().default(false),
  rural_or_critical_access_clinical_sites: z.coerce.boolean().default(false),
  office_anesthesia_sites: z.coerce.boolean().default(false),
  crna_only_clinical_sites: z.coerce.boolean().default(false),
  ...
  support_for_underrepresented_minorities: z.coerce.boolean().default(false),
